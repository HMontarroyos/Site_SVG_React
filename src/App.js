...
import praiaCaiaques from "./assets/vectors/praia-caiaques.svg";
import praiaFooter from "./assets/vectors/praia-footer.svg";
...
function App() {
  return (
    <div className="App">
      ...
      <img src={praiaCaiaques} alt="" />
        <svg
          className="lett-header"
      ...
      <section id="section-dicas" className="section-dicas">
        <h1>O verão chegou, se liga nessas dicas!</h1>

        <div className="container-cards">
          <article className="card card-esq">
            <Tween scale={0.95} repeat={-1} yoyo={true}>
              <svg
                id="coqueiro"
                className="icone"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="-400 0 1200 565.85"
              >
            ...
            <p>
              Evite permanecer sob o sol nos horários mais quentes do dia (entre
              10 e 16 horas), beba mais líquidos do que sua sede sinaliza,
              evitando bebidas alcoólicas (elas provocam perda de líquidos), use
              roupas leves e claras, de algodão, consuma alimentos leves, como
              frutas e verduras.
            </p>
          </article>
          <article className="card card-dir">
            <Tween scale={0.95} repeat={-1} yoyo={true}>
              <svg
                id="filtro"
                className="icone"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="-320 0 900 437.19"
              >
                <title>filtro</title>
                <g id="_Group_" data-name="&lt;Group&gt;">
                  ...
                  <polygon
                    id="_Path_"
                    data-name="&lt;Path&gt;"
                    points="233.65 301.73 40.88 301.73 8.26 7.39 266.27 7.39 233.65 301.73"
                    fill="#fff"
                  />
                  <polygon
                    id="_Path_2"
                    data-name="&lt;Path&gt;"
                    points="210.81 301.73 37.57 301.73 8.26 7.39 240.13 7.39 210.81 301.73"
                    fill="#f9a333"
                  />
                  <polygon
                    id="_Path_3"
                    data-name="&lt;Path&gt;"
                    points="263.74 30.25 266.27 7.39 8.26 7.39 10.79 30.25 263.74 30.25"
                    fill="#fff"
                  />
                  <line
                    id="_Path_4"
                  ...
                  <path
                    id="_Path_5"
                    data-name="&lt;Path&gt;"
                    d="M178.91,402.56a40.1,40.1,0,0,0-79.85,0Z"
                    transform="translate(-1.72 -2.81)"
                    fill="#fff"
                  />
                  <line
                    id="_Path_6"
            ...
            <p>
              O uso do protetor solar é extremamente importante, ele ajuda a
              combater o câncer de pele, que pode ser causado pelo longo período
              de exposição ao sol. Além de evitar a insolação, queimaduras,
              manchas, envelhecimento precoce, flacidez, lesões, entre outras
              complicações.
            </p>
          </article>
        </div>
      ...
      <section className="container-footer">
        <svg
          className="lett-footer"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 640.01 199.3"
        >
